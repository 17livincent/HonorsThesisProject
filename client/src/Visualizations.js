...
class Visualizations extends React.Component {
    ...
    render() {
        ...
        this.origPlots = origDensityPlots;//origLinePlots.concat(origHistograms, origDensityPlots, origHeatmaps);
        this.prepPlots = prepDensityPlots;//prepLinePlots.concat(prepHistograms, prepDensityPlots, prepHeatmaps);
